...
public class KeyedTableFileScanHelper implements TableFileScanHelper {
  ...
  public KeyedTableFileScanHelper(KeyedTable arcticTable, MixedSnapshot snapshot) {
    this.arcticTable = arcticTable;
    this.baseSnapshotId = snapshot.getBaseSnapshotId();
    this.changeSnapshotId = snapshot.getChangeSnapshotId();
  }
  ...
  public CloseableIterable<FileScanResult> scan() {
    ...
    if (changeSnapshotId != INVALID_SNAPSHOT_ID) {
      StructLikeMap<Long> optimizedSequence =
          baseSnapshotId == INVALID_SNAPSHOT_ID
