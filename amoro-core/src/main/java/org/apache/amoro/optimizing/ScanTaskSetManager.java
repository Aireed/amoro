...
public class ScanTaskSetManager {
  ...
  private final Map<Pair<String, String>, List<?>> tasksMap = Maps.newConcurrentMap();
  ...
  public <T> void stageTasks(MixedTable table, String setId, List<T> tasks) {
  ...
  public <T> List<T> fetchTasks(MixedTable table, String setId) {
    Pair<String, String> id = toId(table, setId);
    return (List<T>) tasksMap.get(id);
  }

  @SuppressWarnings("unchecked")
  public <T> List<T> removeTasks(MixedTable table, String setId) {
    Pair<String, String> id = toId(table, setId);
    return (List<T>) tasksMap.remove(id);
  }

  public Set<String> fetchSetIds(MixedTable table) {
  ...
  private String tableUUID(MixedTable MixedTable) {
    Table table =
  ...
  private Pair<String, String> toId(MixedTable table, String setId) {
